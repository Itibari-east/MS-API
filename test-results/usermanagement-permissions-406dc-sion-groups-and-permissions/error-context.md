...
- Name: usermanagement/permissions.spec.ts >> Permission Management >> creates permission groups and permissions
- Location: tests/usermanagement/permissions.spec.ts:4:7
